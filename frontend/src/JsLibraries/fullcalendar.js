  ...
  */
  ...
  var View = fc.View = Class.extend({
    ...
    display: function(date) {
      ...
      return this.clear().then(function() { // clear the content first (async)
        return (
        _this.displaying = $.when(_this.displayView(date)) // displayView might return a promise
          .then(function() {
  ...
  fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {
    ...
    if ($.datepicker) {
      ...
      $.datepicker.regional[dpLangCode] = $.datepicker.regional[langCode] = // aliasdpOptions;
