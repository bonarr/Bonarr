  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Label kind={getLabelKind(supportsOnGrab, onGrab)}>
          On Grab
        </Label>

        <Label kind={getLabelKind(supportsOnDownload, onDownload)}>
          On Download
        </Label>

        <Label kind={getLabelKind(supportsOnUpgrade, onDownload && onUpgrade)}>
          On Upgrade
        </Label>

        <Label kind={getLabelKind(supportsOnRename, onRename)}>
          On Rename
        </Label>
