...
var MonitorCell = require('./Cells/MonitorCell');
var Messenger = require('../Shared/Messenger');

module.exports = Marionette.Layout.extend({
    className : 'modal-lg',
    template  : 'BulkAdd/BulkAddLayoutTemplate',
    ...
    ui : {
        importButton : '.x-add-all'
    },

    events : {
        'click .x-add-all' : '_addAll'
    },
    ...
    _showSelectFolder : function () {
        ...
        this.listenTo(this.selectFolderView, 'bulkAdd', this._bulkAdd);
    },
