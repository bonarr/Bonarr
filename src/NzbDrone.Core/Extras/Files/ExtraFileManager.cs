...
namespace NzbDrone.Core.Extras.Files
{
    public interface IManageExtraFiles
    {
        ...
        IEnumerable<ExtraFile> CreateAfterMovieScan(Movie movie, MovieFile movieFiles);
        ...
        IEnumerable<ExtraFile> MoveFilesAfterRename(Movie movie, MovieFile movieFile);
...

    {
        ...
        public abstract IEnumerable<ExtraFile> CreateAfterMovieScan(Movie movie, MovieFile movieFiles);
        ...
        public abstract IEnumerable<ExtraFile> MoveFilesAfterRename(Movie movie, MovieFile movieFile);
